...
function activar(id_div){
    ...
    case 1:
            ...
            $("#email_login_sigesco_laboral").attr("placeholder", "Usuario o Email");
        break;
    case 2:
            $( "#signin" ).removeClass( "activo" );
            $( "#signup" ).addClass( "activo" );
            $( "#reset" ).removeClass( "activo" );
            $("#email_login_sigesco_laboral").attr("placeholder", "RUN o Email");
        break;
    case 3:
            $( "#signin" ).removeClass( "activo" );
            $( "#signup" ).removeClass( "activo" );
