...
<div id="page-content" class="candidate-profile">
        <div class="container">
              <div id="candidate-profile">
                <div class="row">
                  <div id="datos_candidato" class="col-xl-12">
...
$( document ).ready(function() { 
    ...
    $('#example').DataTable({
        "dom": '<"row separar"<"col-md-12 col-xs-12"<"row"<"col-md-3 col-xs-6" l><"col-md-5 col-xs-6" f><"#botones_tabla.col-md-4 col-xs-12">>>>t<"row"<"col-md-6 col-xs-6" i><"col-md-6 col-xs-6" p>>',
    ...
    $("#example_filter").css("width","100%");
    $("#example_filter label").css("width","100%");
    $("#example_filter label input").css("width","100%");
    $("#example_info").css("width","45%");
    $("#example_paginate").css("width","100%");
