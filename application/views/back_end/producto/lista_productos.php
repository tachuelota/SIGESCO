        ...
        <div class="container">
          <div class="title-breadcrumb clearfix">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Artículos / Lista de Artículos</li>
            </ol>
            ...
            <div class="row">
                  <div id="" class="col-xl-12">
                    <div class="candidate-description" style="padding:2% 5% 2% 5%">
                        <table id="tabla_lista_productos" class="table table-bordered hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Descripción</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr style="cursor:pointer" onmouseover="this.style.backgroundColor='#66ABE2',this.style.color= 'white'"  onmouseout="this.style.backgroundColor='transparent',this.style.color= 'black'" id="trabajador_" style ="cursor:pointer;">
                                        ...
                                        <td><?=$producto->unidad_medida_producto?></td>
...
$( document ).ready(function() { 
    ...
    $("#tabla_lista_productos_filter").css("width","100%");
    $("#tabla_lista_productos_filter label").css("width","100%");
    $("#tabla_lista_productos_filter label input").css("width","100%");
    $("#tabla_lista_productos_info").css("width","45%");
    $("#tabla_lista_productos_paginate").css("width","100%");
